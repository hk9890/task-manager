...
- [CLI-SPEC.md](specs/CLI-SPEC.md) — the `atctl` command surface, options, and JSON output.
...
`github.com/hk9890/agent-tasks/sdk/tasks` without the CLI's dependencies; the root
