...
func TestDeferred_IsValidStatus(t *testing.T) {
...
func TestDeferred_ExcludedFromReady(t *testing.T) {
	s, _ := newMemStore(t)
...
func TestDeferred_StaysInActivePartition(t *testing.T) {
	s, _ := newMemStore(t)
...
func TestImport_DeferredStatusPassesThrough(t *testing.T) {
	s, _ := newMemStore(t)
